	...
	private LineupLayoutUtils() {
	 ...
	 private static final Map<String, List<Point2D>> FORMATION_COORDS = new HashMap<>();
	    ...
	    static {
	        ...
	        FORMATION_COORDS.put("5-3-2", Arrays.asList(
	        		new Point2D(573, 677), // Name Player 1
		            new Point2D(504, 598), // Name Player 2
		            new Point2D(573, 612), // Name Player 3
		            new Point2D(642, 598), // Name Player 4
		            new Point2D(432, 588), // Name Player 5
		            new Point2D(712, 588), // Name Player 6
		            new Point2D(573, 500), // Name Player 7
		            new Point2D(512, 444), // Name Player 8
		            new Point2D(633, 444), // Name Player 9
		            new Point2D(530, 280), // Name Player 10
		            new Point2D(618, 280)  // Name Player 11
	        ));
	        
	        FORMATION_COORDS.put("5-2-2-1", Arrays.asList(
	        		new Point2D(573, 677), // Name Player 1
		            new Point2D(504, 598), // Name Player 2
		            new Point2D(573, 612), // Name Player 3
		            new Point2D(642, 598), // Name Player 4
		            ...
		            new Point2D(512, 444), // Name Player 7
		            new Point2D(633, 444), // Name Player 8
		            new Point2D(474, 321), // Name Player 9
		            new Point2D(674, 321), // Name Player 10
		            new Point2D(573, 281)  // Name Player 11
	        ));
	        
	        FORMATION_COORDS.put("3-4-2-1", Arrays.asList(
	        		new Point2D(573, 677), // Name Player 1
		            new Point2D(481, 589), // Name Player 2
		            new Point2D(573, 599), // Name Player 3
		            new Point2D(665, 589), // Name Player 4
		            new Point2D(512, 444), // Name Player 5
		            new Point2D(633, 444), // Name Player 6
		            new Point2D(443, 405), // Name Player 7
		            new Point2D(702, 405), // Name Player 8
		            new Point2D(474, 321), // Name Player 9
		            new Point2D(674, 321), // Name Player 10
		            new Point2D(573, 281)  // Name Player 11
	        ));
